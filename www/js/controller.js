angular.module('starter.controllers', ['starter.photoProvider'])

.controller('DashCtrl', function($scope, $window) {
	

	$scope.openMWPhotoBrowser = function (){
		// var data = angular.module('starter.photoProvider', []);
		
		try{
			// console.log($scope.photos.photos[0]);
			...
			*/
			...
			window.plugins.mwPhotoBrowser.showGallery(
	...
	$scope.getPicture = function (){
		try{
			...
			$window.imagePicker.getPictures(function (success) {
				console.log('success : ' + JSON.stringify(success));
				$scope.photos = success.images;
			},
			function (fail) {
	...
	$scope.takePicture = function (){
		$window.Camera.getPicture(function successCallback(success){
	...
	$scope.showCaptionInput = function (){
		var images = [];
		var thumbnails = [];
			/*
			{
			...
			*/
			...
			var options = {
				'images' : $scope.photos ,
				'thumbnails' : $scope.photos ,
				'index':1
			}
			window.plugins.photoCaptionInputView.showCaptionInput(
				options , 
				function (result){
					console.log('result : ' + result);
				},
